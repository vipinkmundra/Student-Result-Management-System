...
public class adminIndex extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "CS", "IT", "ME", "EE", "CE" }));
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        String fathersName = (String)jTextField4.getText();
        ...
        try{
            ...
            st.executeUpdate("insert into student values('"+rollNo+"','"+courseName+"','"+branch+"','"+name+"','"+gender+"','"+fathersName+"')");
